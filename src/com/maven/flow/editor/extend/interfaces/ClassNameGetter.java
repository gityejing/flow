...
public class ClassNameGetter {
	...
	public static String[] getFinishCondiction(){
		String s[]={
				FinishedNoCondiction.class.getName(),
	...
	public static void main(String args[]){
		Set set=ClassUtil.getClasses(Package.getPackage("com.maven.flow.editor.extend.impl"));
		if(set!=null){
	...
	public static String[] getBeforeHandleClass(){
		String s[]={
				...
				BeforeEnd.class.getName(),
				BeforeNotifySendEnd.class.getName()
		};
	...
	public static String[] getAfterHandleClass(){
		String s[]={
				AfterNotUse.class.getName(),
				AfterCheck.class.getName(),
